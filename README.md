...
![Duplicate Check](./Screenshots/02_Duplicate_Check.png)

### 3. Data Model

![Data Model](./Screenshots/03_Data_Model.png)

### 4. Core KPIs

![Core KPIs](./Screenshots/04_Core_KPIs.png)

### 5. Location Analysis

![Location Analysis](./Screenshots/05_Location_Analysis.png)

### 6. Restaurant & Category Analysis

![Restaurant & Category Analysis](./Screenshots/06_Restaurant_Analysis.png)

### 7. Date & Time Analysis

![Date & Time Analysis](./Screenshots/07_Date_Time_Analysis.png)

### 8. Advanced SQL Ranking

![Advanced SQL Ranking](./Screenshots/08_Advanced_SQL_Ranking.png)
...
- 📋 **Business Requirements** — [View Business Requirements](./Business_Requirements.docx)
- 📊 **Dataset Folder** — [View Dataset](./Dataset/)
- 💻 **SQL Queries** — [View SQL Queries](./SQL_Queries/swiggy_analysis.sql)
